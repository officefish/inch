...
const StyledSVG = tw.svg`
    ...
    ${(p) => (p.$primary ? "hover:text-primary-light" : "hover:text-secondary-light")}
    fill-current 
    cursor-pointer
    `

const ToggleEyeInput = ({primary, size, checked, onChange}) => {

    return (checked)
        ? <StyledSVG onClick={onChange} $size={size} $primary={primary} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
        ...
        :   <StyledSVG onChange={onChange} $size={size} $primary={primary} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                <path strokeLinecap="round" strokeLinejoin="round"
...
export default ToggleEyeInput

ToggleEyeInput.propTypes = {
